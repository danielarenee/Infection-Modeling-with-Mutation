# Bifurcation diagram (Casagrandi figure 3)
...
#const SEED_β0 = [130.0, 200.0, 350.0, 500.0, 750.0, 900.0, 1100.0, 1300.0, 1450.0, 1600.0, 1750.0, 1900.0]
...
# Essential for populating the `amplitude` field used in our filters.
...
# 4. 1-PARAMETER CONTINUATION (HORIZONTAL SWEEP) 
...
# 5. 2-PARAMETER CONTINUATION (BOTH DIRECTIONS) 
