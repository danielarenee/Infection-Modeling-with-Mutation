#!/usr/bin/env python3
"""
Endemic prevalence surface and asymptotic approximations (Prevalence-driven variant)
...
series expansions for the prevalence-driven SIRCm model.
...
SAVE_PATH = SCRIPT_DIR / "16_endemic_prevalence_surface.png"
