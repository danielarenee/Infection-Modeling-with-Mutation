...
def main():
    ...
    for i, sig in enumerate(sigmas):
        ...
        # Identify the vertex where branches meet (minimum epsilon)
        ...
        # Determine the maximum valid tilde_eps for this slice in both branches
    ...
    # Plot upper and lower sheets using the custom warm gradient colormap
    ax1.plot_surface(eps_mesh, sig_mesh, upper_grid, cmap=warm_cmap, alpha=0.85,
                     shade=True, edgecolor='none', rstride=1, cstride=1)
