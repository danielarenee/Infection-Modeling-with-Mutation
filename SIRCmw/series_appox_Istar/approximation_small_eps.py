...
P = mu * ( A(I) + eps*B(I) + eps^2*C(I) ),   deg_I A = 2,  deg_I B = deg_I C = 3.
...
a2, a1, a0 = sp.Poly(A, I).all_coeffs()      # A = a2 I^2 + a1 I + a0
disc = sp.expand(a1**2 - 4*a2*a0)            # I* = (-a1 +- sqrt(disc))/(2 a2)
dA = sp.expand(sp.diff(A, I).subs(I, Is))    # A'(I*) = 2 a2 I* + a1 = +-sqrt(disc)
