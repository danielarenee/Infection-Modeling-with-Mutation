...
# discards N_transient steps, then sample I for N sample steps
# Returns the period of the attractor
@njit
def classify_point(beta0, eps, mu, alpha, delta, gamma, sigma,
    ...
    # 1. Transient (300 yrs of simulation)
    ...
    # I_samples will now have the value of I at the end of each yaer

    # 3. classify (count distinct values)
...
# draw a line at Beta_0= mu+alpha (below this line R_=<1 and the disease dies out)
